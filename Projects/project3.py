...
draw_rectangle("light yellow", -100, 100, 200, 200)
draw_rectangle("light pink", 100, -100, 200, 200)
draw_rectangle("light green",-100, -100, 200, 200)

s1 = create_sprite("soccer", 100, 100)
s2 = create_sprite("squirrel", -100, -100)
s3 = create_sprite("image", -100, 100)
s4 = create_sprite ("chicken tenders", 100, -100)

message1 = create_sprite("alien",-200,200)
message1.color("red")
message1.write("sadie",font = ("Arial", 40, "normal"))
message1.hideturtle()

message2 = create_sprite("alien",-200,-250)
message2.color("blue")
message2.write(" i like to play soccer",font = ("Arial", 40, "normal"))
message2.hideturtle()
